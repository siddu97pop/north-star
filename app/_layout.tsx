...
function RootLayoutNav() {
  ...
  return (
    <Stack>
      ...
      <Stack.Screen name="recommendations" options={{ title: 'Suggestions', presentation: 'modal' }} />
      <Stack.Screen name="interaction/[id]" options={{ title: 'Source Interaction', presentation: 'modal' }} />
    </Stack>
  );
}
